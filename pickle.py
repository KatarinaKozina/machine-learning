...
forecast_out = int(math.ceil(0.05 * len(df)))# ceil zaokruzuje na sljedecu vecu vrijednost, len vraća duljinu
...
#pokrenemo ovo zajedno s gornjih 4 reda,
#treniranje i testiranje pohranjujemo na disk u binarnom obliku:serijalizacija


pickle_in = open('linearregression.pickle','rb')
clf = pickle.load(pickle_in)  #zakomentiramo treniranje i testiranje i pickle.dump 
clf.fit(x_train, y_train)
#When you call fit method it estimates the best
#representative function for the the data points
#(could be a line, polynomial or discrete borders around).
